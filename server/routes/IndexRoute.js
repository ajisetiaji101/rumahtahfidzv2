...
router.use(config.URL_API + "/pondok", verifyToken, PondokRoute);
router.use(config.URL_API + "/masterpondok", verifyToken, MasterPondokRoute);
router.use(config.URL_API + "/alquransantri", verifyToken, AlquranSantriRoute);
router.use(
  config.URL_API + "/surahpendeksantri",
  verifyToken,
  SurahPendekSantriRoute
);
router.use(config.URL_API + "/iqrosantri", verifyToken, IqroRoute);
...
router.use(config.URL_API + "/guru", verifyToken, GuruRoute);
router.use(config.URL_API + "/santri", verifyToken, SantriRoute);
